...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.matteogassend.bluetooth_classic.BluetoothClassicPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin bluetooth_classic, com.matteogassend.bluetooth_classic.BluetoothClassicPlugin", e);
    }
    try {
